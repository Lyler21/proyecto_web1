...
<html>
    ...
    <body>
        ...
        <div align="center">
            Karumi Florerias en lima, es una Tienda de flores y regalos online, donde diseñamos tus sentimientos para que puedas expresarte. <br>
            Somos especialistas en diseño floral. Delivery de cortesía si ordenas Ahora. Importante: Todos los pedidos son con 24 horas de anticipación. <br>
            Nunca fue tan fácil enviar flores y regalos en Lima.<br><br>
        </div>
        <div align="center">
            <h2>Todos Nuestros Productos</h2><br>
        <table>
            <tr>
                <td valign="top">
                    Categoria<br>
